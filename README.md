...
# 📖 [My Microverse LEADERBOARD PROJECT] <a name="about-project"></a>
...
-  Items can be added to the board.
...
- navigate to clone and copy the link git@github.com:Simpleshaikh1/LeaderBoard.git
